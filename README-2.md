...
使用 [minimist](https://github.com/substack/minimist) 解析命令行参数。
...
完整代码可以查看 [mp-cli/src/utils/getConfig.js 文件](https://github.com/lxchuan12/mp-cli/blob/main/src/utils/getConfig.js)。
